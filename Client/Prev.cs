...
namespace Task2
{
    class Prev : Java.Lang.Object, ISurfaceHolderCallback, Android.Hardware.Camera.IPreviewCallback
    {
        ...
        private Android.Hardware.Camera.Size FindMinSize(IList<Android.Hardware.Camera.Size> sizes)
        {
            Android.Hardware.Camera.Size[] orderByDescending = sizes
                                    .OrderBy(x => x.Width)
                                    .ToArray();
        ...
        {
            Android.Widget.Toast.MakeText(MainActivity.global_activity, "DESTROYED", Android.Widget.ToastLength.Long).Show();
            StopCamera();
        }
        ...
        public void SetFocusModeAuto(Android.Hardware.Camera.Parameters oldParameters)
        {
            ...
            {
                oldParameters.FocusMode = Android.Hardware.Camera.Parameters.FocusModeAuto;
            }
        }
